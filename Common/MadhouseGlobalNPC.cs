...
namespace TerramazingGijinkaMadhouse.Common
{
    ...
    public class MadhouseGlobalNPC : GlobalNPC
    {
        ...
        //    {
        //        //TerramazingGijinkaMadhouseMod.Instance.Logger.Info($"{npc.FullName}");
        //        drawColor = MadhouseUtils.ColorSwap(Mindcrashed.Palette, 2);
        //    }
        //}
        ...
        //        //Vector2 position9 = npc.position;
        //        //float num216 = 0f;
        //        //Color color9 = MadhouseUtils.ColorSwap(Mindcrashed.Palette, 2);
        //        //Color alpha15 = npc.GetAlpha(color9);
